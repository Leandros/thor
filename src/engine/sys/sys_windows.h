/* My own windows header file, which only contains the parts I actually need. */
 ...
 * since C++ sucks, I'll only define the C version here and not the C++ version.
...
/* ========================================================================== */
/* Debugging: */
DLLAPI void WINAPI DebugBreak(void);
...
DLLAPI void WINAPI RaiseException(
